    ...
    def __init__(self):
        ...
        self.parser.add_argument('--arch', default='dla_34',
                                 help='model architecture. Currently tested'
                                      ...
                                      'dlav0_34 | dla_34 | hourglass | dlav0cam_34')
        ...
        self.parser.add_argument('--no_color_aug', action='store_true',
                                 help='not use the color augmenation '
                                      'from CornerNet')
        self.parser.add_argument('--center_ratio', type=float, default=0.5,
                                 help='0.5x for width/length as center offset region')
        ...
        self.parser.add_argument('--mse_loss', action='store_true',
                                 help='use mse loss or focal loss to train '
                                      'keypoint heatmaps.')
        self.parser.add_argument('--iou_loss', action='store_true',
                                 help='use ctdet_iouloss')
        # ctdet
        ...
        self.parser.add_argument('--weak', action='store_true')  # weak training
        # lr和对应的改变时间
        self.parser.add_argument('--prm_lr', default=[0.0, 0.03, 0.003], type=float, nargs='+')
        self.parser.add_argument('--prm_lr_step', default=[90, 120], type=int, nargs='+')

        self.parser.add_argument('--vis_cam', action='store_true') # when web-demo
